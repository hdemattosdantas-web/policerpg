...
import { formatMoneyBRL } from '../components/Dashboard'
...
export function Quartel() {
  ...
  // Hook de sons
  const { tocarCompra, tocarErro } = useSoundEffects()
  ...
  return (
    <div className="quartel">
      ...
      <LoadingOverlay visivel={comprando !== null} mensagem="Processando compra..." />
